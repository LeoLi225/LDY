...
**Step 7.** Click "OAuth2" on the left menu and select "bot" in the "SCOPES". And, You will see "BOT PERMISSIONS". After then, select "Send Messages", "Embed Links", "Attach Files" and "Read Message History" as shown as below images.
